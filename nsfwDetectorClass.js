class NsfwDetector {
    constructor() {
        ...
        this._nsfwLabels = [
            'ANIME_NAKED','ANIME_PORN','CARTOON_NAKED','CARTOON_PORN','CARTOON_KID','ANIME_VULGAR','MALE_FEMALE_NAKED','MALE_FEMALE_PARTIALLY_NAKED','SEX','SEXUAL','FEMALE_BREAST_EXPOSED','KIDS','CHILD_FACE','CHILDREN','TEENAGER','NAKED','NUDE','PARTIAL_NUDITY','FEMALE_GENITALIA_EXPOSED', 'BUTTOCKS_EXPOSED', 'ANUS_EXPOSED',
