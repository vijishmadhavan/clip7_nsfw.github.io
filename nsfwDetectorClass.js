class NsfwDetector {
    constructor() {
        this._nsfwLabels = [
            ...
            'ACCIDENT', 'CRASH', 'DEADLY_INJURY', 'MURDER', 'RIOTS', 'STREET_CRIME', 'VIOLENT_ATTACKS', 'DEAD_BODIES', 'HUMAN_CORPSES', 'ANIMAL_CARCASS',
            'ASSAULT', 'ARSON', 'ATTACK', 'AMBULANCE', 'POLICE', 'FIRE_TRUCK', 'PARAMEDICS', 'ANIMAL_CRUELTY', 'ELDER_ABUSE', 'CHILD_ABUSE', 'SPOUSAL_ABUSE',
            'ARMED_SOLDIERS', 'FIGHTER_JETS', 'TANKS', 'MISSILES', 'DESTROYERS', 'SUBMARINES',
            'EARTHQUAKE_DEVASTATION', 'FLOOD_DESTRUCTION', 'HURRICANE', 'SNOW_STORM', 'TORNADO', 'TSUNAMI', 'WILDFIRE',
            'VIOLENT_PROTESTS', 'VIOLENT_SCUFFLES', 'VIOLENT_CLASHES', 'STONE_PELTING', 'MOB_VIOLENCE',
            'ASSAULT_RIFLES', 'GUNS', 'RIFLES', 'KNIVES', 'AXES', 'SWORDS', 'DEADLY_WEAPONS',
            'FULL-FRONTAL_NUDITY', 'SEXUAL_ACTS', 'HENTAI', 'ANIME_PORN', 'GENITALIA', 'EXPLICIT_SEXUAL_ACT',
            'PARTIAL_NUDITY', 'SEXUALLY_SUGGESTIVE', 'TITILLATING', 'PARTIAL_CLOTHING', 'SEXUALLY_REVEALING', 'SEXTING', 'TWERKING', 'LEWD_&_LASCIVIOUS_CONDUCT',
            'ISIS', 'ALQAEDA', 'TALIBAN', 'HEZBOLLAH', 'ISLAMIC_TERRORISM', 'SUICIDE_BOMBING', 'BOMB_BLAST_ATTACK',
            'KKK', 'WHITE_SUPREMACISTS', 'WHITE-NATIONALIST', 'ANTI-GOVERNMENT_MILITIA', 'ANTI-LGBT', 'ANTI-FEMINIST', 'ANTI-IMMIGRANT', 'ANTI-SEMITISM',
            'COCAINE', 'HEROIN', 'SUBSTANCE_ABUSE', 'METHAMPHETAMINE', 'OXYCONTIN', 'FENTANYL', 'DRUG_CARTELS', 'DRUG_ADDICTION', 'E-CIGARETTES', 'VAPING',
            'PROFANE_LANGUAGE', 'OBSCENE_GESTURE', 'LEWD_CONDUCT', 'GRAPHIC_LANGUAGE',
            'QANON', 'BLACK_LIVES_MATTER', 'ANTI-VACCINE', 'ANTI-MASK', 'GUN_RIGHTS', 'WOKEISM', 'PROUD_BOYS', 'ALT-RIGHT', 'ANTIFA', 'ISLAMOPHOBIA', 'IDENTITY_POLITICS', 'CULTURAL_APPROPRIATION',
            'HACKING', 'MALWARE', 'PHISHING', 'IDENTITY_THEFT', 'DATA_BREACH', 'SPYWARE',
        ];
        ...
        this._sfwLabels = [
            ...
            'SFW', 'SUITABLE_FOR_ALL_AUDIENCES', 'SAFE_CONTENT', 'GENERAL_AUDIENCES', 'SUITABLE_FOR_ALL_AGES',
            'CHILD-SAFE_CONTENT', 'CARTOONS', 'SAFE_FOR_CHILDREN', 'BLAND_CONTENT', 'MADE_FOR_KIDS',
            'RELIGIOUS_RITUAL', 'RELIGIOUS_CEREMONY', 'PRAYER', 'WORSHIP', 'RELIGIOUS_GATHERING', 'SPIRITUAL',
            'CELEBRITIES', 'NEWS_PERSONALITIES', 'FAMOUS_POLITICIANS', 'SPORTS_STARS', 'MOVIE_STARS', 'MUSIC_STARS',
        ];
